          ...
          <div className="flex flex-col sm:flex-row gap-md mb-xl">
            ...
            <div className="flex gap-sm flex-1">
              <a
                ...
                className="flex-1 bg-primary text-white px-lg py-md min-h-touch font-medium hover:bg-primary-dark transition-colors rounded shadow-md text-center flex items-center justify-center gap-sm"
              >
              ...
              <a
                ...
                className="flex-1 border-2 border-primary text-primary px-lg py-md min-h-touch font-medium hover:bg-primary/5 transition-colors rounded text-center flex items-center justify-center gap-sm"
              >
